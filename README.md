...
graph TD;
    RESET-->ESTADO 1(INIT);
    ESTADO 1(INIT)-->ESTADO 2(IDDLE);
    ESTADO 2(IDDLE)-->ESTADO 3(LECTURA EMG);
    ESTADO 3(LECTURA EMG)-->ESTADO 4(PROCESAMIENTO DE SEÑAL);
    ESTADO 4(PROCESAMIENTO DE SEÑAL)-->ESTADO 5(RESPUESTA DE ORTESIS);
